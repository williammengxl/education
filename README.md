...
education/
├── read-books/                    阅读相关
│   ├── 01-重要-购买图书收藏.md     购书清单（优先级 · 分批采购 · 蓝思阶梯）
│   ├── 02-系列书目详细档案.md      系列深度档案（出版 · 蓝思 · 内容 · 销量核查）
...
│   ├── 音频-播客podcast.md         播客清单（科学 STEM + 故事神话 + 三位一体联动）
│   └── english-video.md           英文视频资源（规划中）
└── online-platform/               平台与学校
...
| 文档 | 内容 | 状态 |
| :-- | :-- | :-- |
| [01-重要-购买图书收藏](read-books/01-重要-购买图书收藏.md) | 购书清单（英美非虚构科普 + 幽默，800–1200L）：已读区、优先级总表、分批采购、蓝思阶梯与阅读路径、暂缓项 | 📝 持续更新 |
| [02-系列书目详细档案](read-books/02-系列书目详细档案.md) | 购书清单的数据附录：Adam Kay / Horrible Science / Explodapedia 系列全分册表，What If? 2 与 Human Body Theater 单本档案，蓝思阶梯汇总与发行量可得性说明 | ✅ 已完成 |
...
| [教育类AI工具推荐](online-platform/教育类AI工具推荐.md) | 教育向 AI 工具全景指南：16 款总览对比表、七类分场景详表（通用助手/语言/学科/阅读检索/教师备课/留学备考/国内补充）、场景速查、家庭短名单、合规与风险 | ✅ 已完成 |
...
| [Khanmigo商业计划书](online-platform/Khanmigo商业计划书.md) | 标准 BP 七章结构：执行摘要、行业痛点与市场机遇（含 2026.08 教育部证据导向新规）、产品设计与核心机制（双模式/四条设计原则/功能矩阵）、商业模式与财务预测（**三边补贴模式** + 三档情景）、竞争格局与核心壁垒、数据隐私与合规（含护栏已知局限）、战略路线图；附**14 项流传数据核验表**与全量链接核验 | ✅ 已完成 |
...
- [Lexile 官方查询](https://lexile.com) — 蓝思值权威来源
- [vocabulary.com](https://www.vocabulary.com) — 分级词表与书目专属词单
- [Rick Riordan 官网](https://rickriordan.com) — 新书与影视进度
